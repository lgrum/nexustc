...
const LazyUsersChart = lazy(async () => {
  const usersChartModule = await import("@/components/admin/users-chart");

  return { default: usersChartModule.UsersChart };
});

export default async function UsersPage() {
  const data = await orpcClient.user.getDashboard();
