...
function EngagementQuestionEditor({
  ...
  const form = useAppForm({
    ...
    onSubmit: async ({ value }) => {
      const parsed = engagementQuestionCreateSchema.parse(value);
      const parsedValues: EngagementQuestionFormValues = {
        incompatibleTagTermIds: parsed.incompatibleTagTermIds ?? [],
        isActive: parsed.isActive,
        isGlobal: parsed.isGlobal,
        locale: parsed.locale,
        tagTermIds: parsed.tagTermIds ?? [],
        text: parsed.text ?? "",
      };
    ...
    validators: {
      onSubmit: ({ value }) => {
        const result = engagementQuestionCreateSchema.safeParse(value);
