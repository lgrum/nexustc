...
type ForbiddenRules = Awaited<
  ReturnType<typeof orpcClient.moderation.listForbiddenContentRules>
>;

export function ForbiddenContentClient({
  initialRules,
}: {
  initialRules: ForbiddenRules;
}) {
