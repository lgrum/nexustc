(function () {
  ...
  var adConfig = {
    ...
    frequency_count: 1,
    trigger_method: 2,
    trigger_class: "nxtc-popunder-post",
    trigger_delay: 0,
  ...
  var popMagic = {
      ...
      for (
        ...
        if ("string" == typeof i)
          if ("." === i.charAt(0)) {
            var n = i,
              r = i.substring(1);
            if (e.slice(-n.length) === n || e === r) return !0;
          } else {
            var a = e === i,
              c = "." + i,
    ...
    shouldShow: function (e) {
      ...
      var i = popMagic.getCountFromCookie(),
        n = popMagic.getLastOpenedTimeFromCookie(),
        r = Math.floor(Date.now() / 1e3),
        a = n + popMagic.config.trigger_delay;
      return (
        !(n && a > r) &&
        ((popMagic.open_count = i), !(i >= popMagic.config.frequency_count))
      );
    },
    ...
    isAgegoAvailable: function () {
      return "undefined" != typeof Promise && void 0 !== window.AGEGO;
    },
    addAgeGoToken: function (e) {
      return popMagic.isAgegoAvailable()
        ? Promise.race([
            window.AGEGO("getVerificationToken"),
            ...
            .then(function (t) {
              if ((clearTimeout(o), t && t.token)) {
                var i = -1 === e.indexOf("?") ? "?" : "&";
                return e + i + "ag_token=" + encodeURIComponent(t.token);
              }
              return e;
            })
            .catch(function () {
    ...
    addEvent: function (e, o) {
      ...
      if ("3" != popMagic.config.trigger_method)
        if (
          ...
          if (
            ...
            if (
              ...
              for (var n = 0; n < t.length; n++)
                popMagic.addEventToElement(t[n], e, o);
            }
          else {
          ...
          for (
            t = document.querySelectorAll(a.join(", ")), n = 0;
            n < t.length;
            n++
          )
            popMagic.addEventToElement(t[n], e, o);
        ...
        for (t = document.querySelectorAll("a"), n = 0; n < t.length; n++)
          popMagic.addEventToElement(t[n], e, o);
    },
    ...
    methods: {
      default: function (e) {
        ...
        var o = e.target || e.srcElement,
          ...
          i = popMagic.addSuvtValueToUrl(popMagic.url);
        return (
          window.open(t, "_blank"),
          popMagic.setAsOpened(e),
          popMagic.executeOnRedirect(),
          popMagic.isAgegoAvailable()
            ? popMagic.addAgeGoToken(i).then(function (e) {
                popMagic.top.document.location = e;
              })
            : (popMagic.top.document.location = i),
      ...
      chromeTab: function (e) {
        ...
        ((t.href = popMagic.findLinkToOpen(i)),
          ...
          setTimeout(function () {
            popMagic.isAgegoAvailable()
              ? popMagic.addAgeGoToken(popMagic.url).then(function (e) {
                  ((n.location.href = e), popMagic.executeOnRedirect());
                })
